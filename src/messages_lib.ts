const msg = {
  ...
  noFreePlaces: `Sorry, the list of participants is already full.\n
    Despite this, you can deposit USDN on the Launchpad page until ${process.env.DATE3} (CEST): ${process.env.LINK3} \n
